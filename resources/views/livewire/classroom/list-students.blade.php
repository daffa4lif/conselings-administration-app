<div>
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-2">
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-2">
            ...
            <div class="w-full">
                <x-basic-label title="Tahun Ajaran" />
                <select wire:model.live.debounce.400ms="filterYears" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                    <option value="All">Semua</option>
        ...
        <table class="w-full text-sm text-left rtl:text-right text-gray-500">
            ...
            <tbody>
                ...
                <tr class="bg-white border-b hover:bg-gray-100">
                    ...
                    <td class="px-6 py-4">
                        {{ $item->student->updated_at }}
                    </td>
                    <td class="px-6 py-4 text-right">
                        <a href="{{ route('student.detail', $item->student->nis) }}" class="font-medium text-blue-600 hover:underline">Detail</a>
                    </td>
                </tr>
                @empty
                <tr>
