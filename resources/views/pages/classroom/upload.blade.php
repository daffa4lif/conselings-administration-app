@extends('layouts.app', ['title' => 'Upload Data Siswa ke dalam Kelas'])
...
@section('body')
<header>
    <x-main-header title="Tambah data Siswa ke dalam Kelas" />
    <x-breadcrumb :datas="[route('classroom.index') => 'List Kelas', route('classroom.detail', $id) => 'Detail Kelas']" last="Upload Data Siswa" />
</header>
...
<section>
    ...
    <div class="w-full grid grid-cols-1 md:grid-cols-2 p-4 border border-gray-100 shadow rounded-lg gap-5">
        <div class="">
            ...
            <div class="mt-6">
                <a href="{{ asset('assets/spreadsheet/tamplate-siswa-kelas.xlsx') }}" class="w-full flex items-center justify-center gap-2 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2 me-2 mb-2" download>Download Tamplate <i class="fa-solid fa-file-arrow-down"></i></a>
            </div>
        </div>
        <form action="" method="post">
            ...
            <div class="mb-5">
                <x-basic-label for="tahun" title="Tahun Ajaran" />
                <x-basic-input type="number" id="tahun" name="year" value="{{ old('year') }}" required />
            </div>
...
<section class="mt-10">
                ...
                <tbody>
                    @foreach ($reports['error']['duplicate'] as $item)
                        <tr class="bg-white border-b">
                            ...
                            <td class="px-6 py-4">
                                <a href="{{ route('student.detail', $item['2']) }}" target="__blank" class="text-blue-500 hover:underline">Detail</a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
    ...
    <div class="w-full p-4 border border-gray-100 shadow rounded-lg gap-5 my-4">
        <div class="flex p-4 mb-4 text-sm text-red-800 border-t-4 border-red-300 bg-red-50" role="alert">
            ...
            <div>
                <span class="font-medium">Tahun ajar yang sama terdeteksi :</span>
                <ul class="mt-1.5 list-disc list-inside">
                    <li>Siswa tersebut sudah pernah terdaftar pada kelas tertentu dengan tahun yang sama</li>
                    <li>Ubah secara manual pada detail siswa</li>
                </ul>
            </div>
        </div>
        <div class="relative overflow-x-auto">
            <table class="w-full text-sm text-left rtl:text-right text-gray-500">
                ...
                <tbody>
                    @foreach ($reports['error']['same'] as $item)
                        <tr class="bg-white border-b">
                            <td class="px-6 py-4">
                                {{ $item['1'] }}
                            </td>
